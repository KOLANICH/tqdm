...
try:
    ...
    # DBusProgressReporter = DBusProgressReporterV3  # for now no substantional advantages (v3 may be a bit less overheady in initialization), implements essentially the same functionality
